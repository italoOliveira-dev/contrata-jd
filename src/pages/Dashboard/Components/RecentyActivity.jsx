...
const RecentActivity = () => {
  return (
    <div className="bg-[#161E54] h-auto w-auto sm:h-[400px] sm:w-[271px] md:h-[424px] md:w-[271px] md:mr-0 lg:h-[258px] lg:w-[427px] rounded-lg text-white">
      ...
      <div className="p-5">
        ...
        <div className="flex md:flex-col lg:flex-row gap-[38px] text-start mt-2 sm:mt-5 md:items-baseline">
