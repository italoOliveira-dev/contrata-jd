...
export default function EstatusEmpresa({ estatus }) {
  return (
    <div
      className="border border-[#E0E0E0] rounded-[10px] p-[20px] grid grid-cols-2 gap-1 w-96 max-md:w-full 
            max-lg:flex-grow"
    >
      ...
      <div className="p-[15px]">
        ...
        <div className="bg-[#FFEFE7] rounded-[4px] ">
          <span className="text-[#303030] px-1 text-xs font-normal">
            +{estatus.valorPorcento}% Mês passado
          </span>
        </div>
      </div>
    </div>
