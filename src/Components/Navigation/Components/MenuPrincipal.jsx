    ...
    <div>
      ...
      <div className="flex-col text-left">
        <Menu className="ml-0 mr-0 mb-10">
          ...
          <Link className="ml-0 mr-0" to="/recrutamento">
            <MenuItem className="">
              <div className="flex p-5 space-x-5">
                <svg
                  width="24"
                ...
                <span className="">Recrutamento</span>
              </div>
            </MenuItem>
          </Link>

          <Link className="ml-0 mr-0" to="/agendamento">
            <MenuItem className="">
              <div className="flex p-5 space-x-5">
                <svg
                  width="24"
          ...
          <Link className="ml-0 mr-0" to="/colaboradores">
            <MenuItem className="">
              <div className="flex p-5 space-x-5">
                <svg
                  width="20"
                ...
                <span className="">Colaboradores</span>
              </div>
            </MenuItem>
          </Link>
          <Link className="ml-0 mr-0" to="/departamento">
            <MenuItem className="">
              <div className="flex p-5 space-x-5">
                <svg
                  width="24"
